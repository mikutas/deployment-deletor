...
// DeploymentMaxAgeSpec defines the desired state of DeploymentMaxAge
type DeploymentMaxAgeSpec struct {
...
type DeploymentMaxAge struct {
	...
	Spec   DeploymentMaxAgeSpec   `json:"spec,omitempty"`
...
type DeploymentMaxAgeList struct {
	...
	Items           []DeploymentMaxAge `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DeploymentMaxAge{}, &DeploymentMaxAgeList{})
}
