...
//+kubebuilder:rbac:groups=mikutas.example.com,resources=deploymentdeletors,verbs=get;list;watch;create;update;patch;delete
...
func (r *DeploymentDeletorReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("deploymentdeletor", req.NamespacedName)
